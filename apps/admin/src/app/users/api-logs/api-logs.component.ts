...
import { LogsData } from 'apps/admin/src/modals/instituteApiLogs.model';
import { Actor, ApiLogData, EventObject, ProcessedUserEventData, User, } from 'apps/admin/src/modals/users.model';
...
export class ApiLogsComponent implements OnInit {
  ...
  public searchUserEvents(isLoadMore: boolean): void {
    ...
    let apiCallPayloadObject: ApiLogData= {
      ...
      instituteName: this.userInfoData?.profile?.iid,
    }
    if (!isLoadMore) {
